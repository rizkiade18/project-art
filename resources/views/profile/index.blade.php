                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('profile') }}">
                        ...
                        <div class="form-group row py-2">
                            <label for="nik" class="col-md-2 col-form-label text-md-right">{{ __('NIK') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="kota" type="text" class="form-control @error('kota') is-invalid @enderror" name="kota" value="{{ $user->kota }}" required autocomplete="kota" autofocus>
                        ...
                        <div class="form-group row py-2">
                            <label for="jenis_kelamin" class="col-md-2 col-form-label text-md-right">{{ __('Jenis Kelamin') }}</label>

                            <div class="col-md-6">
                                <select id="jenis_kelamin" class="form-control @error('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin" value="{{ $user->jenis_kelamin }}" required autocomplete="jenis_kelamin" autofocus>
